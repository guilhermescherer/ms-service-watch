...
@Component
public class ServiceEndpointUpdateConverter implements UpdateConverter<ServiceEndpointRequest, ServiceEndpoint> {

    @Override
    public ServiceEndpoint convert(ServiceEndpointRequest source, ServiceEndpoint target) {
